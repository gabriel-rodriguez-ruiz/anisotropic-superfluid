...
file_to_open = data_folder / "n_theta_mu_-39_L=1000_h=0.01_theta_in_(0.0-3.142)B=0.18_Delta=0.2_lambda_R=0.56_lambda_D=0_g_xx=1_g_xy=1_g_yy=2_g_yx=0_points=24.npz"
