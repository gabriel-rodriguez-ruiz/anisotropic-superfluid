...
file_to_open = data_folder / "n_By_mu_-39_L=1000_h=0.01_B_y_in_(0.0-0.6)_Delta=0.2_lambda_R=0.56_lambda_D=0_g_xx=1_g_xy=1_g_yy=2_g_yx=-2_theta=0_points=24.npz"
...
# ax.plot(B_values/Delta, n_B_y[:,0]+n_B_y[:,1]+n_B_y[:,2]+n_B_y[:,3], "-o",  label=r"$n_{s,xx}+n_{s,yy}+n_{s,xy}+n_{s,yx}$")
