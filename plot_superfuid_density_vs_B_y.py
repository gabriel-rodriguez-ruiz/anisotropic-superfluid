...
file_to_open = data_folder / "n_By_mu_-39_L=1000_h=0.01_B_y_in_(0.0-0.3)_Delta=0.2_lambda_R=0.56_lambda_D=0.2_g_xx=1.5_g_xy=-1_g_yy=2_g_yx=1_theta=0_points=24.npz"
...
#%%
data_folder = Path("Data/")
file_to_open = data_folder / "n_By_mu_-39_L=1000_h=0.01_B_y_in_(0.0-0.3)_Delta=0.2_lambda_R=0.56_lambda_D=0_g_xx=1_g_xy=2_g_yy=1_g_yx=0_theta=0_points=32.npz"
Data = np.load(file_to_open)

file_to_open2 = data_folder / "n_By_mu_-39_L=1000_h=0.01_B_y_in_(0.0-0.3)_Delta=0.2_lambda_R=0.56_lambda_D=0_g_xx=1_g_xy=2_g_yy=1_g_yx=0_theta=1.57_points=32.npz"
